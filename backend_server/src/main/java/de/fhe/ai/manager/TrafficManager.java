...
import de.fhe.ai.model.TemporaryLine;
...
public class TrafficManager {
     ...
     */
    public boolean addTemporaryLine(TemporaryLine temporaryline) {
        return this.temporaryLines.add(temporaryline);
    }
     ...
     */
    public boolean removeTemporaryLine(TemporaryLine temporaryLine) {
        return this.temporaryLines.remove(temporaryLine);
    }
     ...
     * @throws IllegalArgumentException if the lines paths are not directly traversable, that is that moving from destination1 to start2
     */
     ...
     * @throws IllegalArgumentException if the line paths are not directly traversable, that is that moving from destination1 to start2
     */
