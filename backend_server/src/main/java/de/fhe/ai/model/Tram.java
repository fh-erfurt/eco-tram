...
public abstract class Tram extends ModelBase {
    ...
    public Collection<Line> getPaths() {
        return queuedLines;
    }
     ...
     * @throws IllegalStateException if this tram cannot move from it's current destination/position to the start of the new line
     */
     ...
     * @throws IllegalStateException if this tram cannot move from it's current destination/position to the start of the new ine
     */
