...
public class EventManagerTest {
    ...
    public void get_single_event_entity_instance() {
        Tram exampleTramObject = new PassengerTram(0,100,1000,100,"passenger");
    ...
    public void test_multiple_entities_and_listener() {
        Tram firstTramObject = new PassengerTram(0,100,1000,100,"passenger");
        Tram secondTramObject = new PassengerTram(0,100,1000,100,"passenger");
